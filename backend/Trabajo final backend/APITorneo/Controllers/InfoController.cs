...
namespace APITorneo.Controllers
{
    ...
    public class InfoController(IDAOUsuario dao_usuario, IUsuarioService usuarioService, IInfoService infoService) : Controller
    {
        ...
        // INFO DE TORNEOS: parte publica, deber�a tener restricciones?
        [HttpGet("torneos")]
        ...
        [EndpointDescription("se retorna toda la informaci�n relacionada al torneo")]
        ...
        [ProducesResponseType<IEnumerable<DTOUsuario>>(200)]
        [ProducesResponseType<IEnumerable<DTOUsuarioConIdCreador>>(200)]
        [EndpointDescription("se retorna segun el usuario logeado, todos los usuarios del sistema que puede ver (no puede ver roles con mayor jerarqu�a)")]
